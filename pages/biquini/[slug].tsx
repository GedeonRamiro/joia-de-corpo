                        ...
                        <div className='hero-content flex-col lg:flex-row'>
                            ...
                            <div>
                                ...
                                <div className='flex'>
                                    {product.pieceSize &&
                                        product.pieceSize.map((size, index) =>
                                            size.active === true ? (
                                                <button
                                                    onClick={() => buttonAction(size.size)}
                                                    key={index}
                                                    className={` ${
                                                        sizeProduct === size.size
                                                            ? 'bg-pink-400 border-none'
                                                            : ''
                                                    } cursor-pointer w-9 h-9 font-semibold text-gray-800 flex justify-center items-center rounded-md border border-gray-400 text-sm mr-2`}
                                                >
                                                    {size.size}
                                                </button>
                                            ) : (
                                                <button
                                                    key={index}
                                                    className='bg-gray-200 cursor-default w-9 h-9 font-semibold flex text-gray-400 justify-center items-center rounded-md border border-gray-400 text-sm mr-2'
                                                >
                                                    {size.size}
                                                </button>
                                            )
                                ...
                                <button
                                    ...
                                    className={`sm:btn-md btn mt-4 bg-pink-400 hover:bg-pink-500 border-none ${
                                        sizeProduct ? '' : 'btn-disabled'
                                    }`}
                                >
